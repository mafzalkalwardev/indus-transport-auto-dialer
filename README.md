...
# ðŸ“ž Indus Transport Auto Dialer
...
Professional Windows desktop dialer for dispatch and outbound calling teams. Agents use a simple branded app while Google Voice runs in the background on each line.
